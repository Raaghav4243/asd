...
let tutorialPages = [
    {
        ...
        content: (
            <div className="tutorial-content">
                ...
                <Image className="img-fluid" src="../public/Images/TitleBanner.png" />
            </div>
        ),
    },
    {
                ...
                <Carousel>
                    <Carousel.Item>
                        <img
                            ...
                            src="../public/Images/SidebarTutorial.jpg"
                            alt="First slide"
                        />
                        <Carousel.Caption>
                            <h3>Sidebar</h3>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/NavTutorial.jpg"
                            alt="Second slide"
                        />
                        <Carousel.Caption>
                            <h3>Navbar</h3>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/CanvasTutorial.jpg"
                            alt="Third slide"
                        />
                        <Carousel.Caption>
            ...
            <div className="tutorial-content">
                ...
                <Carousel interval={null}>
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/PlacingElementTutorial.gif"
                            alt="First slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/SelectingGroupTutorial.gif"
                            alt="Second slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/DraggingElementTutorial.gif"
                            alt="Third slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/DeletingElementsTutorial.gif"
                            alt="Fourth slide"
                        />
                        <Carousel.Caption>
            ...
            <div className="tutorial-content">
                ...
                <Carousel interval={null}>
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/ConnectingElementsTutorial.gif"
                            alt="First slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/RemovingWireTutorial.gif"
                            alt="Second slide"
                        />
                        <Carousel.Caption>
            ...
            <div className="tutorial-content">
                ...
                <Carousel interval={null}>
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/CreatingCircuitTutorial.gif"
                            alt="First slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/NamingSwitchTutorial.gif"
                            alt="Second slide"
                        />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img
                            className="d-block w-100"
                            src="../public/Images/AddingCircuitTutorial.gif"
                            alt="Third slide"
                        />
                        <Carousel.Caption>
                            <h3 className="text-info">
    ...
    },
    {
        ...
        content: (
            <div className="tutorial-content">
                ...
                {/* <img
                    className="img-fluid"
                    src="../public/Images/CircuifySevenSegment.gif"
                ></img> */}
                <img
                    class="d-block w-100"
                    src="../public/Images/CircuifySevenSegment.gif"
