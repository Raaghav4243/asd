...
export default class Sidebar extends React.Component {
    ...
    render() {
        const tools = [
            {
                image: "../public/Images/Cursor.png",
                name: "SELECT",
            },
            {
                image: "../public/Images/DeleteWire.png",
                name: "REMOVE WIRE",
            },
        ];
        ...
        const inputs = [
            {
                image: "../public/Images/True.png",
                name: "TRUE",
            },
            {
                image: "../public/Images/False.png",
                name: "FALSE",
            },
            {
            ...
            {
                image: "../public/Images/Button.png",
                name: "BUTTON",
            },
            {
                image: "../public/Images/Switch.png",
                name: "SWITCH",
            },
        ];
        ...
        const outputs = [
            {
                image: "../public/Images/Lightbulb.png",
                name: "LIGHT BULB",
            },
            {
                image: "../public/Images/Hexdigit02.png",
                name: "HEX DIGIT",
            },
            {
                image: "../public/Images/SevenSegment.png",
                name: "SEVEN SEGMENT",
            },
            {
                image: "../public/Images/Oscilloscope.png",
                name: "O-SCOPE",
            },
        ];
        ...
        const flipflops = [
            {
                image: "../public/Images/SRFlip-Flop.png",
                name: "SR FLIP-FLOPs",
            },
            {
                image: "../public/Images/DFlip-Flop.png",
                name: "D FLIP-FLOP",
            },
            {
                image: "../public/Images/JKFlip-Flop.png",
                name: "JK FLIP-FLOP",
            },
            {
                image: "../public/Images/TFlip-Flop.png",
                name: "T FLIP-FLOP",
            },
        ];
        ...
        const plexers = [
            {
                image: "../public/Images/Multiplexer.png",
                name: "MUX",
            },
            {
                image: "../public/Images/Demultiplexer.png",
                name: "DEMUX",
            },
        ];
        ...
        for (let i = 1; i < tabs.length; i++) {
            if (tabs[i] !== currentCircuit) {
                circuits.push({
                    image: "../public/Images/IntegratedCircuit.png",
                    name: tabs[i],
                });
            }
        }
